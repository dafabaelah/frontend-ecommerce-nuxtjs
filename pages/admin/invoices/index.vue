            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="card border-0 rounded shadow-sm border-top-orange">
                        ...
                        <!-- pagination -->
                        <b-pagination align="right" :value="invoices.current_page" :total-rows="invoices.total" :per-page="invoices.per_page" @change="changePage" aria-controls="my-table"></b-pagination>
...
<script>
    export default {
        ...
        async asyncData({ store }) {
            // dispatch adalah fungsi yang digunakan untuk memanggil action pada vuex
        ...
        methods: {
            ...
            searchData() {
                ...
                // mengambil dari folder store admin/invoice.js
                this.$store.dispatch('admin/invoice/SET_PAGE', 1)
