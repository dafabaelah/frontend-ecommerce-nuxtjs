                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <!-- pagination -->
                            <b-pagination align="right" :value="customers.current_page" :total-rows="customers.total" :per-page="customers.per_page" @change="changePage" aria-controls="my-table"></b-pagination>
